...
struct ColorTheme2 {
    let accent = Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))
    let background = Color(#colorLiteral(red: 0.9995340705, green: 0.988355577, blue: 0.4726552367, alpha: 1))
